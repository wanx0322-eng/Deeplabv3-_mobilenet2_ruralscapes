    ...
    def paintEvent(self, event):
        ...
        if self.polygon_points:
            ...
            if self._cursor_pos is not None:
                painter.setPen(QPen(QColor("#ffd75f"), 1, Qt.DashLine))
        ...
        if (self.tool in ("brush", "eraser") and self._cursor_pos is not None
            ...
            color = QColor("#ff6b6b") if self.tool == "eraser" else \
...
class AnnotatePage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.dirty_label.setStyleSheet("color: #ffd75f; font-weight: bold;")
        ...
        for key, text, tip in (
            ...
            button.setStyleSheet("QToolButton { padding: 6px 10px; }")
    ...
    def refresh(self):
        ...
        for e in self.entries:
            ...
            item.setForeground(QColor("#7bd88f") if e.label_path
                               else QColor("#9aa3b2"))
    ...
    def save_label(self):
        ...
        if 0 <= row < len(self.entries):
            ...
            self.list_widget.item(row).setForeground(QColor("#7bd88f"))
